...
public class DefaultColors {
    ...
    public static void includeDarkColors(Model model) {
        model.addAttribute("defaultDarkColors", darkColors);
    }

    private static final List<DefaultColor> darkColors = Arrays.asList(
